        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-4 col-md-6 footer-about">
                <a href="/" class="d-flex align-items-center mb-3">
                    <img src="/assets/img/logoL.png" alt="Logo" style="height: 50px; margin-right: 10px;">
                    <span class="sitename">DESA LAWEYAN</span>
                </a>
                <div class="footer-contact pt-3">
                    <p class="mb-2"><i class="bi bi-geo-alt me-2"></i>Kecamatan Sumberasih</p>
                    <p class="mb-2"><i class="bi bi-map me-2"></i>Kabupaten Probolinggo</p>
                    <p class="mb-2"><i class="bi bi-envelope me-2"></i>desalaweyan@gmail.com</p>
                ...
                <div class="row gy-3">
                    ...
                    <div class="col-12">
                        ...
                        <div class="social-links d-flex flex-wrap gap-2">
                            <a href="https://www.youtube.com/@desa.laweyan.probolinggo" 
                               target="_blank" 
                               rel="noopener noreferrer"
                               aria-label="YouTube">
                                <i class="bi bi-youtube"></i>
                            </a>
                            <a href="https://www.facebook.com/DesaLaweyanProbolinggo" 
                               target="_blank" 
                               rel="noopener noreferrer"
                               aria-label="Facebook">
                                <i class="bi bi-facebook"></i>
                            </a>
                            <a href="https://www.instagram.com/desa.laweyan.probolinggo" 
                               target="_blank" 
                               rel="noopener noreferrer"
                               aria-label="Instagram">
                                <i class="bi bi-instagram"></i>
                            </a>
                            <a href="https://www.tiktok.com/@desa.laweyan.probolinggo" 
                               target="_blank" 
                               rel="noopener noreferrer"
                               aria-label="TikTok">
    ...
    <div class="container copyright text-center mt-4">
        <div class="row">
            <div class="col-12">
                ...
                <p class="mb-0 small">
                    Website Resmi Desa Laweyan, Kecamatan Sumberasih, Kabupaten Probolinggo
                </p>
            </div>
        </div>
    </div>

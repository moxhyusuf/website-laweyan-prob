    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="small-box bg-warning">
                <div class="inner">
                    <h3>{{ $jumlahPembangunan }}</h3>
                    <p>Pembangunan</p>
                </div>
                <div class="icon"><i class="fas fa-person-digging"></i></div>
                <a href="{{ route('admin.pembangunan.index') }}" class="small-box-footer">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-12">
            <div class="card card-outline card-primary h-100">
                ...
                <div class="card-body">
                    <p>
                        Selamat datang di <strong>Dashboard Admin Desa Laweyan</strong>.

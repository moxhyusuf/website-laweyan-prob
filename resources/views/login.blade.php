...
<head>
    ...
    <title>Login - Desa Laweyan</title>
    
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="{{ asset('dist/img/logoL.png') }}">
    <link rel="shortcut icon" type="image/png" href="{{ asset('dist/img/logoL.png') }}">
        ...
        <div class="container h-100">
            <div class="row justify-content-md-center align-items-center h-100">
                <div class="card-wrapper">
                    <div class="brand">
                        <img src="{{ asset('dist/img/logoL.png') }}" alt="Desa Laweyan" width="144">
                    </div>
                    <div class="card fat">
                        <div class="card-body">

<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('admin.dashboard') }}" class="brand-link">
        <img src="{{ asset('dist/img/logoL.png') }}"
             class="brand-image img-circle elevation-3"
             style="opacity:.8"
             alt="Logo">
        <span class="brand-text font-weight-light">Desa Laweyan</span>
    </a>
    ...
    <a href="#" class="d-block">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" 
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.kelembagaan.index') }}"
                               class="nav-link {{ request()->routeIs('admin.kelembagaan.*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Kelembagaan</p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.pembangunan.index') }}"
                               class="nav-link {{ request()->routeIs('admin.pembangunan.*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <!-- Ruang Pemuda -->
                <li class="nav-item">
                    <a href="{{ route('admin.ruang_pemuda.index') }}"
                       class="nav-link {{ request()->routeIs('admin.ruang_pemuda.*') ? 'active' : '' }}">
                ...
                <!-- Ruang Mitra -->
                <li class="nav-item">
                    <a href="{{ route('admin.ruang_mitra.index') }}"
                       class="nav-link {{ request()->routeIs('admin.ruang_mitra.*') ? 'active' : '' }}">

...
Route::get('/kelembagaan', [KelembagaanController::class, 'frontend'])->name('kelembagaan.frontend');
...
Route::get('/pembangunan', [PembangunanController::class, 'frontend'])->name('pembangunan.frontend');
Route::get('/pembangunan/{pembangunan}', [PembangunanController::class, 'frontendDetail'])
    ->name('pembangunan.detail');
...
Route::get('/ruang_pemuda', [RuangPemudaController::class, 'frontend'])->name('ruangpemuda.frontend');
Route::get('/ruang_pemuda/{id}', [RuangPemudaController::class, 'show'])->name('ruang_pemuda.show');

Route::get('/galeri', [GaleriController::class, 'frontend'])->name('galeri.frontend');

Route::get('/ruang_mitra', [MitraController::class, 'frontend'])->name('ruang_mitra.index');
...
Route::get('/admin/dashboard', [DashboardController::class, 'index'])
    ...
    Route::get('kelembagaan/create', [KelembagaanController::class, 'create'])->name('kelembagaan.create');
    Route::post('kelembagaan', [KelembagaanController::class, 'store'])->name('kelembagaan.store');
    ...
    Route::delete('kelembagaan/{id}', [KelembagaanController::class, 'destroy'])->name('kelembagaan.destroy');
    ...
    // Ruang Pemuda CRUD
    Route::resource('ruang_pemuda', RuangPemudaController::class);
    Route::get('/ruang_pemuda/{id}/edit', [RuangPemudaController::class, 'edit'])->name('ruang_pemuda.edit');
    Route::put('/ruang_pemuda/{id}', [RuangPemudaController::class, 'update'])->name('ruang_pemuda.update');
    Route::get('/ruang_pemuda/create', [RuangPemudaController::class, 'create'])->name('ruang_pemuda.create');
    Route::post('/ruang_pemuda/store', [RuangPemudaController::class, 'store'])->name('ruang_pemuda.store');
    Route::delete('/ruang_pemuda/{id}', [RuangPemudaController::class, 'destroy'])->name('ruang_pemuda.destroy');

    //Ruang Mitra
    Route::get('/ruang_mitra', [MitraController::class, 'index'])->name('ruang_mitra.index');
    Route::get('/ruang_mitra/create', [MitraController::class, 'create'])->name('ruang_mitra.create');
    Route::post('/ruang_mitra', [MitraController::class, 'store'])->name('ruang_mitra.store');
    Route::get('/ruang_mitra/{id}/edit', [MitraController::class, 'edit'])->name('ruang_mitra.edit');
    Route::put('/ruang_mitra/{id}', [MitraController::class, 'update'])->name('ruang_mitra.update');
    Route::delete('/ruang_mitra/{id}', [MitraController::class, 'destroy'])->name('ruang_mitra.destroy');
    ...
    Route::get('/pembangunan/{id}/edit', [PembangunanController::class, 'edit'])->name('pembangunan.edit');
    Route::put('/pembangunan/{id}', [PembangunanController::class, 'update'])->name('pembangunan.update');
    ...
    Route::delete('/pembangunan/{id}', [PembangunanController::class, 'destroy'])->name('pembangunan.destroy');
    Route::delete('/media/{media}', [App\Http\Controllers\PembangunanController::class, 'destroyMedia'])
    ...
    Route::get('/admin/pembangunan/{id}', [PembangunanController::class, 'show'])->name('admin.pembangunan.show');
